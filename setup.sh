...
echo "   /plugin marketplace add beCyborg/jadlis-notifications"
echo ""
...
echo "   /jadlis-notifications:init"
echo ""
echo "5. Configure notification sounds (optional):"
echo "   /jadlis-notifications:settings"
echo ""
...
echo "      run /jadlis-notifications:init for the first time."
echo ""
