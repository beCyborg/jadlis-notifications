...
INSTALL_SCRIPT_URL="https://raw.githubusercontent.com/beCyborg/jadlis-notifications/main/bin/install.sh"
...
echo ""
echo "Next steps:"
echo "  Run /jadlis-notifications:settings to configure sounds and notifications"
```
